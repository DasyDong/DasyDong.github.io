...
![image](/img/images/pics/k8s/hpa-logic.png)
...
![k8s-ca](/img/images/pics/k8s/k8s-ca.png "k8s-ca")
...
### 扩容流程
![k8s-ca-up](/img/images/pics/k8s/k8s-ca-up.png "k8s-ca-up")
...
### CA集群状态检查
![k8s-cluster](/img/images/pics/k8s/k8s-cluster.png "k8s-cluster")
...
## CA代码逻辑解析
### CA 时序图
![ca](/img/images/pics/k8s/k8s-ca-logic.png)


### CA scaldown流程图
![ScaleDown](/img/images/pics/k8s/k8s-scaledown-2.png)


### CA scalup流程图

![ScaleUp](/img/images/pics/k8s/k8s-scale-up.png)


### cloudprovider 简单版流程图
![CA](/img/images/pics/k8s/paas-ca.png)
...
![hpa](/img/images/pics/k8s/hpa.png 'hpa')
...
![vpa](/img/images/pics/k8s/vpa.png 'vpa')
...
CA工作流
![ca](/img/images/pics/k8s/ca.png 'ca')
...
![ca-hpa-vpa](/img/images/pics/k8s/ca-hpa-vpa.png 'ca-hpa-vpa')
